...
using SpotFinderWebSeleniumTests.Pages;
using SpotFinderWebSeleniumTests.Utilities;
using System;
...
namespace SpotFinderWebSeleniumTests.Tests
{
    public class BaseTest
    {
        ...
        protected void LaunchBrowser(string URL)
        {
            ...
            string driversPath = @"C:\Users\mbrzoska\Desktop\SpotFinderWebSeleniumTests\StarterForSeleniumAutomation\Drivers";
